...
def parse_args():
    ...
    parser.add_argument("--images", default="/media/ubuntu/seu219/zhaoziyu/torch-ngp/data/nerf_blender_data/treasure2/images", help="input path to the images folder, ignored if --video is provided")
    ...
    parser.add_argument("--colmap_text", default="sparse/0", help="input path to the colmap text files (set automatically if run_colmap is used)")
