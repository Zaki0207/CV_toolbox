...
file_path = '/Users/zhaozizyu/Downloads/zy/frame-000188.depth.png'
...
img_show = cv2.applyColorMap(imgDepth, cv2.COLORMAP_JET)
# img_show_gray = cv2.cvtColor(img_show, cv2.COLOR_RGB2GRAY)
